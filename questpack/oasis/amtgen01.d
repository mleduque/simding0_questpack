...
StartCutSceneMode()
Wait(1)
ForceSpellRES("d0oasis9",Player1)
Wait(1)
EndCutSceneMode()
...
!Alignment(Player1,CHAOTIC_NEUTRAL)~ THEN BEGIN F1
  SAY @500132
...
IF ~Global("d0divineintent","LOCALS",1)
!Alignment(Player1,MASK_EVIL)
!Alignment(Player1,CHAOTIC_NEUTRAL)~ THEN BEGIN F2
  SAY @500133
      =
      @500112
...
IF ~Global("d0divineintent","LOCALS",1)
Alignment(Player1,CHAOTIC_NEUTRAL)~ THEN BEGIN F3
  SAY @500134
  IF ~~ THEN DO ~SetGlobal("d0divineintent","LOCALS",2)
SetGlobal("TethyrBattleStart","GLOBAL",1)
Enemy()
